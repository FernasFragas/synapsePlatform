...
**Test Date:** Sun Mar 22 17:16:03 WET 2026
**Git Commit:** 01cbe1c
**Machine:** arm64
**OS:** Darwin 25.3.0
...
### Baseline Metrics
```
Process Stats:   0.0  0.1  27136 437336768
...
| **Failed Messages** | 1 |
| **Success Rate** | 0.00% |
| **Actual Throughput** | 0.0 msg/sec |
| **Peak Kafka LAG** | - |
| **Average Kafka LAG** | 0 |
| **Final Kafka LAG** | - |
| **Error Count** | [0;32m[INFO][0m Sampling application logs for Test1...
       0 |
| **Process Stats (CPU% MEM% RSS VSZ)** |   0.0  0.1  24912 437337024 |
